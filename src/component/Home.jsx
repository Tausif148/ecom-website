const Home = () => {
    return (
        <section className="-50 py-8 antialiased dark:-900 md:py-12">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                    ...
                    <div className="flex items-center space-x-4">
                        <button
                            ...
                            type="button"
                            className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:-800 dark:text-gray-400 dark:hover:-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto"
                        >
                            <svg
                        ...
                        <div
                            id="dropdownSort1"
                            className="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:-700"
                        ...
                        >
                            ...
                            >
                                <li>
                                    <a
                                        href="#"
                                        className="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:-100 hover:text-gray-900 dark:text-gray-400 dark:hover:-600 dark:hover:text-white"
                                    >
                                        {" "}
                                        The most popular{" "}
                                    </a>
                ...
                <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:-800">
                            ...
                            <div className="mb-4 flex items-center justify-between gap-4">
                                ...
                                <div className="flex items-center justify-end gap-1">
                                    <button
                                        ...
                                        className="rounded-lg p-2 text-gray-500 hover:-100 hover:text-gray-900 dark:text-gray-400 dark:hover:-700 dark:hover:text-white"
                                    >
                                    ...
                                    <div
                                        ...
                                        role="tooltip"
                                        className="tooltip invisible absolute z-10 inline-block rounded-lg -900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:-700"
                ...
                <div className="w-full text-center">
                    <button
                        type="button"
                        className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:-800 dark:text-gray-400 dark:hover:-700 dark:hover:text-white dark:focus:ring-gray-700"
                    >
                        Show more
                    </button>
                </div>
            ...
            >
                <div className="relative h-full w-full max-w-xl md:h-auto">
                    {/* Modal content */}
                    <div className="relative rounded-lg bg-white shadow dark:-800">
                        {/* Modal header */}
                        <div className="flex items-start justify-between rounded-t p-4 md:p-5">
                            ...
                            <button
                                type="button"
                                className="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:-100 hover:text-gray-900 dark:hover:-600 dark:hover:text-white"
                                data-modal-toggle="filterModal"
                            >
                                <svg
                                    className="h-5 w-5"
                        ...
                        <div className="px-4 md:px-5">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                type="checkbox"
                                                defaultValue=""
                                                className="h-4 w-4 rounded border-gray-300 -100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                                            />
                                            <label
                                                htmlFor="apple"
                            ...
                            >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                defaultValue={300}
                                                step={1}
                                                className="h-2 w-full cursor-pointer appearance-none rounded-lg -200 dark:-700"
                                            />
                                        </div>
                                        <div>
                                            <label
                                        ...
                                        <div className="col-span-2 flex items-center justify-between space-x-2">
                                            <input
                                                ...
                                                min={0}
                                                max={7000}
                                                className="block w-full rounded-lg border border-gray-300 -50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 "
                                                placeholder=""
                                                required=""
                                            />
                                ...
                                <div>
                                    ...
                                    <ul className="flex w-full items-center rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-900 dark:border-gray-600 dark:-700 dark:text-white">
                                        <li className="w-full border-r border-gray-200 dark:border-gray-600">
                                            <div className="flex items-center pl-3">
                                                <input
                                                    ...
                                                    name="list-radio"
                                                    defaultChecked=""
                                                    className="h-4 w-4 border-gray-300 -100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
                                                />
                                                <label
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label
                                                    ...
                                                    className="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-300"
                                                >
                                                    <div className="mr-2 h-3.5 w-3.5 rounded-full -400" />
                                                    Gray
                                                </label>
                                            </div>
                                            <div className="flex items-center">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center">
                                                <input
                                                    ...
                                                    defaultValue=""
                                                    name="rating"
                                                    className="h-4 w-4 border-gray-300 -100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                                                />
                                                <label
                                                    htmlFor="five-stars"
                                    ...
                                    <ul className="grid grid-cols-2 gap-4">
                                        <li>
                                            ...
                                            <label
                                                ...
                                                className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:-800 dark:text-gray-400 dark:hover:-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5"
                                            >
                                                <div className="block">
                        ...
                        <div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                            ...
                            <button
                                type="reset"
                                className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:-800 dark:text-gray-400 dark:hover:-700 dark:hover:text-white dark:focus:ring-gray-700"
                            >
                                Reset
                            </button>
                        </div>
