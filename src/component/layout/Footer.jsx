                            ...
                            <div className="space-y-5 rounded-lg bg-gray-100 p-6 dark:bg-gray-700">
                                ...
                                <div>
                                    ...
                                    <div className="gap-4 space-y-4 sm:flex sm:space-y-0">
                                        <a
                                            href="#"
                                            className="inline-flex w-full items-center justify-center rounded-lg -800 px-4 py-2.5 text-white hover:-700 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:-600 dark:hover:-500 dark:focus:ring-gray-800 sm:w-auto"
                                        >
                                            <svg
